# Support for Output Descriptors in HelixAlpha Core

Since HelixAlpha Core v0.17, there is support for Output Descriptors in the
...
on HelixAlpha's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing HelixAlpha Core wallets, a convenience function `combo` is
