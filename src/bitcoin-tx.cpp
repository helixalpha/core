...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " helixalpha-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  helixalpha-tx [options] <hex-tx> [commands]  Update hex-encoded helixalpha transaction\n" +
            "or:     helixalpha-tx [options] -create [commands]   Create hex-encoded helixalpha transaction\n" +
            "\n";
