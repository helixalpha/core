...
"""Verify that starting helixalpha with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start helixalpha with -h for help text")
        ...
        self.log.info("Start helixalpha with -version for version information")
        ...
        self.log.info("Start helixalphad with -fakearg to make sure it does not start")
